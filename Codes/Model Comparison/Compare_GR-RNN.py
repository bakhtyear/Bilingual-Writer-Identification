...
cnn_model = keras.Sequential([
    # Block 1
    layers.Conv2D(64, kernel_size=(3, 3), strides=(1, 1), padding='same', input_shape=(32, 32, 3)),
    ...
    # Fully connected layer(s) and output layer
...
# Train the model
cnn_model.fit(X_train, y_train, epochs=16, batch_size=32, validation_split=0.1)
